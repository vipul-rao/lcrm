<section id="nav_{{$nav_id}}">
    ...
    @if(Request::is('/'))
        @include('layouts.frontend.headers.home_headercontent')
    @elseif(Request::is('about_us'))
        @include('layouts.frontend.headers.about_headercontent')
        @elseif(Request::is('contactus'))
        @include('layouts.frontend.headers.contact_headercontent')
    @endif
</section>
