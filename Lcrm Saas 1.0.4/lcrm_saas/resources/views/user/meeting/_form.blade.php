<div class="card">
    <div class="card-body">
        @if (isset($meeting))
            {!! Form::model($meeting, ['url' => $type . '/' . $meeting->id, 'method' => 'put', 'files'=> true]) !!}
        @else
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group required {{ $errors->has('responsible_id') ? 'has-error' : '' }}">
                        ...
                        <div class="controls">
                            {!! Form::select('responsible_id', $staffs, isset($meeting)?$meeting->responsible_id:null, ['class' => 'form-control']) !!}
